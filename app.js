...
async function renderFCSScoreboard(){
  ...
  const FCS_LOGO_IDS={
    ...
    'Yale':'43','William & Mary':'2729','Southern Illinois':'79','Sacramento State':'16','Harvard':'108','Western Carolina':'2717','West Florida':'110242','South Carolina State':'2569','Abilene Christian':'2000','Mercer':'2382','Austin Peay':'2046','Villanova':'222','Louisville':'97','Lehigh':'2329','Illinois State':'2287','Tarleton State':'348','Rhode Island':'227','Youngstown State':'2754','Tennessee Tech':'2633','Stephen F. Austin':'2617','Northern Iowa':'2448','Richmond':'2678','New Hampshire':'160','Maine':'311'
  };
  const bigSkyAliases={
  ...
  function top25Card(t,events,scheduled){
    ...
    if(ev){
      ...
      // When ESPN provides homeAway, trust that as the authoritative ordering.
      // The scheduled matchup is only a fallback for older cached events.
  ...
  function injectStyles(){
    ...
    const s=document.createElement('style');s.id='ghq-fcs-scoreboard-surgical-styles';s.textContent=`
      ...
      .ghq-fcs-top-team-row>span:not(.fcs-team-rank){font-size:15px!important;font-weight:750!important;line-height:1.15!important;min-width:0!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}.ghq-fcs-top-team-row.no-logo{grid-template-columns:34px minmax(0,1fr) auto!important}.ghq-fcs-top-team-row.no-logo>span:not(.fcs-team-rank){white-space:normal!important;overflow:visible!important;text-overflow:clip!important}
